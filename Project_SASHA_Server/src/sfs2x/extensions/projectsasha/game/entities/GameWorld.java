...
public class GameWorld 
{
	...
	public GameWorld(int id)
	{
		...
		gateways.put("iceland",				new Scientific(null, "nome", "Iceland", 221, 176, 64.963051f, -19.020835f));
		gateways.put("great britain",		new Base(null, "nome", "Great Britain", 138, 30, 55.378051f, -3.435973f));
		gateways.put("scandinavia", 		new Educational(null, "nome", "Scandinavia", 203, 106, 62.278648f, 12.340171f));
		gateways.put("northern europe",		new Bank(null, "nome", "Northern Europe", 194, 23, 52.519171f, 13.406091f));
		...
		gateways.put("madagascar",			new Bank(null, "nome", "Madagascar", 311, -306, -18.766947f, 46.869107f));
		gateways.put("south africa",		new Educational(null, "nome", "South Africa", 231, -308, -30.559482f, 22.937506f));
		gateways.put("middle east",			new Base(null, "nome", "Middle East", 302, -71, 29.298528f, 42.550960f));
		gateways.put("afghanistan",			new Military(null, "nome", "Afghanistan", 377, -8, 33.939110f, 67.709953f));
		gateways.put("india",				new Scientific(null, "nome", "India", 422, -110, 20.593684f, 78.962880f));
		gateways.put("siam",				new Base(null, "nome", "Siam", 511, -135, 51.506568f, 3.633689f));
		gateways.put("china",				new Government(null, "nome", "China", 484, -40, 35.861660f, 104.195397f));
		...
		gateways.put("mongolia",			new Base(null, "nome", "Mongolia", 545, 30, 46.862496f, 103.846656f));
		gateways.put("irkutsk",				new Educational(null, "nome", "Irkutsk", 518, 62, 52.277141f, 104.304164f));
		...
		gateways.put("japan",				new Scientific(null, "nome", "Japan", 322, -8, 36.204824f, 138.252924f));
		gateways.put("indonesia",			new Base(null, "nome", "Indonesia", 555, -202, -0.789275f, 113.921327f));
		gateways.put("western australia", 	new Government(null, "nome", "Western Australia", 562, -319, -27.672817f, 121.628310f));
		gateways.put("eastern australia", 	new Bank(null, "nome", "Eastern Australia", 649, -294, -35.778940f, 137.795825f));
		gateways.put("new guinea", 			new Base(null, "nome", "New Guinea", 639, -220, -5.092566f, 140.711092f));
		gateways.put("alaska", 				new Scientific(null, "nome", "Alaska", -244, 128, 64.200841f, -149.493673f));
		gateways.put("north west territory",new Base(null, "nome", "North West Territory", -146, 122, 39.800603f, -89.725199f));
		gateways.put("alberta", 			new Base(null, "nome", "Alberta", -136, 70, 53.933271f, -116.576504f));
		...
		gateways.put("ontario", 			new Base(null, "nome", "Ontario", -64, 65, 51.253775f, -85.323214f));
		gateways.put("central america", 	new Base(null, "nome", "Central America", -137, -68, 12.769013f, -85.602364f));
		gateways.put("quebec",				new Base(null, "nome", "Quebec", -12, 65, 52.939916f, -73.549136f));
		gateways.put("greenland",			new Government(null, "nome", "Greenland", 85, 166, 71.706936f, -42.604303f));
		gateways.put("venezuela",			new Base(null, "nome", "Venezuela", -185, -120, 6.423750f, -66.589730f));
		gateways.put("peru",				new Base(null, "nome", "Perù", -163, -184, -9.189967f, -75.015152f));
