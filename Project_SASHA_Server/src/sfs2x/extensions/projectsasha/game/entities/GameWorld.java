...
public class GameWorld 
{
	...
	public GameWorld(int id)
	{
		...
		gateways.put("iceland",				new Scientific(null, "nome", "Iceland", -112, 212, 64.963051f, -19.020835f));
		gateways.put("great britain",		new Base(null, "nome", "Great Britain", -74, 158, 55.378051f, -3.435973f));
		gateways.put("scandinavia", 		new Educational(null, "nome", "Scandinavia", -6, 225, 62.278648f, 12.340171f));
		gateways.put("northern europe",		new Bank(null, "nome", "Northern Europe", -21, 151, 52.519171f, 13.406091f));
		gateways.put("ukraine", 			new Base(null, "nome", "Ukraine", 50, 171, 48.379433f, 31.165580f));
		gateways.put("western europe",		new Educational(null, "nome", "Western Europe", -81, 103, 40.463667f, -3.749220f));
		gateways.put("southern europe",		new Base(null, "nome", "Southern Europe", -7, 126, 41.608635f, 21.745275f));
		gateways.put("north africa",		new Base(null, "nome", "North Africa", -85, 25, 21.007890f, -10.940835f));
		gateways.put("egypt",				new Military(null, "nome", "Egypt", -9, 55, 26.820553f, 30.802498f));
		gateways.put("east africa",			new Base(null, "nome", "East Africa", 35, -15, -0.023559f, 37.906193f));
		gateways.put("congo",				new Base(null, "nome", "Congo", -20, -44, -0.228021f, 15.827659f));
		gateways.put("madagascar",			new Bank(null, "nome", "Madagascar", 66, -96, -18.766947f, 46.869107f));
		gateways.put("south africa",		new Educational(null, "nome", "South Africa", 0, -115, -30.559482f, 22.937506f));
		gateways.put("middle east",			new Base(null, "nome", "Middle East", 46, 73, 29.298528f, 42.550960f));
		gateways.put("afghanistan",			new Military(null, "nome", "Afghanistan", 105, 123, 33.939110f, 67.709953f));
		gateways.put("india",				new Scientific(null, "nome", "India", 141, 52, 20.593684f, 78.962880f));
		gateways.put("siam",				new Base(null, "nome", "Siam", 199, 25, 51.506568f, 3.633689f));
		gateways.put("china",				new Government(null, "nome", "China", 484, 3, 35.861660f, 104.195397f));
		gateways.put("ural",				new Base(null, "nome", "Ural", 125, 175, 54.428772f, 40.057638f));
		gateways.put("siberia",				new Base(null, "nome", "Siberia", 193, 221, 34.627258f, -115.987335f));
		gateways.put("mongolia",			new Base(null, "nome", "Mongolia", 204, 122, 46.862496f, 103.846656f));
		gateways.put("irkutsk",				new Educational(null, "nome", "Irkutsk", 269, 151, 52.277141f, 104.304164f));
		gateways.put("yakutsk",				new Base(null, "nome", "Yakutsk", 290, 216, 62.026324f, 129.731145f));
		gateways.put("kamchatka",			new Base(null, "nome", "Kamchatka", 372, 211, 44.708646f, 37.632769f));
		gateways.put("japan",				new Scientific(null, "nome", "Japan", 300, 96, 36.204824f, 138.252924f));
		gateways.put("indonesia",			new Base(null, "nome", "Indonesia", 234, -54, -0.789275f, 113.921327f));
		gateways.put("western australia", 	new Government(null, "nome", "Western Australia", 292, -143, -27.672817f, 121.628310f));
		gateways.put("eastern australia", 	new Bank(null, "nome", "Eastern Australia", 348, -145, -35.778940f, 137.795825f));
		gateways.put("new guinea", 			new Base(null, "nome", "New Guinea", 331, -67, -5.092566f, 140.711092f));
		gateways.put("alaska", 				new Scientific(null, "nome", "Alaska", -441, 193, 64.200841f, -149.493673f));
		gateways.put("north west territory",new Base(null, "nome", "North West Territory", -329, 182, 39.800603f, -89.725199f));
		gateways.put("alberta", 			new Base(null, "nome", "Alberta", -354, 134, 53.933271f, -116.576504f));
		gateways.put("western usa", 		new Bank(null, "nome", "Western USA", -336, 73, 37.661950f, -122.409936f));
		gateways.put("eastern usa", 		new Military(null, "nome", "Eastern USA", -273, 71, 31.952856f, -102.171694f));
		gateways.put("ontario", 			new Base(null, "nome", "Ontario", -292, 126, 51.253775f, -85.323214f));
		gateways.put("central america", 	new Base(null, "nome", "Central America", -303, 13, 12.769013f, -85.602364f));
		gateways.put("quebec",				new Base(null, "nome", "Quebec", -232, 127, 52.939916f, -73.549136f));
		gateways.put("greenland",			new Government(null, "nome", "Greenland", -163, 238, 71.706936f, -42.604303f));
		gateways.put("venezuela",			new Base(null, "nome", "Venezuela", -239, -48, 6.423750f, -66.589730f));
		gateways.put("peru",				new Base(null, "nome", "Perù", -250, -89, -9.189967f, -75.015152f));
		gateways.put("brazil",				new Military(null, "nome", "Brazil", -193, -110, -14.235004f, -51.925280f));
		gateways.put("argentina",			new Government(null, "nome", "Argentina", -231, -183, -38.416097f, -63.616672f));	
